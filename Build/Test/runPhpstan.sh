...
#   13.4/14.3: composer update --no-scripts --ignore-platform-reqs --with=typo3/cms-core:^<version>
# then: vendor/bin/phpstan analyse --configuration=.github/phpstan_<version>.neon
#
# Usage: Build/Test/runPhpstan.sh -t <12.4|13.4|14.3>
set -euo pipefail
...
while getopts ":t:h" opt; do
    case ${opt} in
        ...
        h) echo "Usage: $0 -t <12.4|13.4|14.3>"; exit 0 ;;
...
case ${TYPO3_VERSION} in
    12.4|13.4|14.3) ;;
    *) echo "Unsupported TYPO3 version: '${TYPO3_VERSION:-}'" >&2; echo "Usage: $0 -t <12.4|13.4|14.3>" >&2; exit 1 ;;
esac
